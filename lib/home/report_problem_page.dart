                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton(
                        ...
                        child: const Text('📷 Camera', style: AppTextStyles.button),
                      ),
                    ),
                    SizedBox(width: 16),
                    Expanded(
                      child: OutlinedButton(
                        ...
                        child: const Text('📁 Gallery', style: AppTextStyles.button),
                      ),
                    ),
                  ],
                ),
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: OutlinedButton(
                            ...
                            child: Text('Refresh Location', style: AppTextStyles.button,),
                          ),
                        ),
                      ],
                    ),
